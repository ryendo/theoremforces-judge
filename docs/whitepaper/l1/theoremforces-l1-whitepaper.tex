...
\begin{description}[style=nextline,leftmargin=10mm]
  ...
  kill-switch、key revocation、restore、log fork、downstream taint drill を完了する。
\end{description}
...
kill switch と key revocation drill を完了すること。これを L1 production readiness の最低条件とする。
\end{decisionbox}
